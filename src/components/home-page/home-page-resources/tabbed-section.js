        ...
        <div className="tab">
          <div className='stupid-div'>
            ...
            <div className="right-area">
              <p>
                Using our interactive timeline, take a detailed look into over a century of development, civilization, and culture. Throughout its timespan the Houston are has gone through many different names, flags, and faces, so feel free to flip through the chapter book of our history and discover how Katy as we know it came to be. We seek to not just help the people of katy, but to educate them as well.
              </p>
